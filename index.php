...
<html>
    <head> 
        <title>Issy: Points d'intérêts</title> 
        <!--------------- Metatags ------------------->   
        <meta charset="utf-8" />
    ...
    <body>
        ...
        <div data-role="page" id="page1" class="page">
            <header data-role="header" data-posistion="fixed" data-id="constantNav" data-fullscreen="true">
                <span class="ui-title">Issy: Points d'intérêts</span>
                ...
                <div data-role="navbar" class="navbar">
                    <ul>
                        <li><a href="#" class="pois-nearme" data-theme="a">Près de moi</a></li>
                        <li><a href="#" class="pois-showall ui-btn-active" data-theme="a">Voir tous</a></li>
                        <li><a href="#page2" class="pois-list" data-theme="a">Liste</a></li>
                    </ul>
                </div><!-- /navbar -->
            </header>
            ...
            <div data-role="content" id="map-filter">
                ...
                <footer data-role="footer" data-posistion="fixed" data-fullscreen="true" class="filter-footer">
                    <a href="" id="apply" data-icon="gear" data-theme="a" title="Apply" class="ui-btn-right">Choisir</a>
                </footer>
            </div><!--map-filter-->
        ...
        <div data-role="page" id="page2" class="page">
            ...
            <header data-role="header" data-posistion="fixed" data-id="constantNav">
                ...
                <fieldset data-role="controlgroup" class="favourites-button">
                    ...
                    <label for="favourites">Favorites</label>
                </fieldset>
                <a href="" data-icon="back" data-iconpos="notext" data-theme="a" title="Back" data-rel="back" class="ui-btn-right">&nbsp;</a>
                <div data-role="navbar" class="navbar">
                    <ul>
                        <li><a href="#" class="pois-nearme" data-theme="a">Près de moi</a></li>
                        <li><a href="#" class="pois-showall" data-theme="a">Voir tous</a></li>
                        <li><a href="#page2" class="pois-list ui-btn-active" data-theme="a">Liste</a></li>
                    </ul>
                </div><!-- /navbar -->
            </header>
        ...
        <div data-role="page" id="page3" data-title="Event fullstory page title" class="page">
            ...
            <footer data-role="footer" data-posistion="fixed" data-fullscreen="true">
                <a href="" id="addFav" data-icon="star" data-theme="a" title="Add to favourites" data-rel="star" class="ui-btn-center">Ajouter aux favoris</a>
                <a href="" id="removeFav" data-icon="star" data-theme="a" title="Remove from favourites" data-rel="star" class="ui-btn-center">Retirer des favoris</a>
            </footer>
